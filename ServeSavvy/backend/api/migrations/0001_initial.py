# Generated by Django 5.0.1 on 2024-03-23 02:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='menuItems', to='api.category')),
            ],
        ),
        migrations.CreateModel(
            name='Table',
        ...
        migrations.AddField(
            model_name='table',
            name='menuItems',
            field=models.ManyToManyField(blank=True, related_name='tables', through='api.TableMenuItem', to='api.menuitem'),
        ),
    ]
